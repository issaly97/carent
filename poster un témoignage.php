...
if($lastInsertId)
{
$msg="Témoignage soumis avec succès";
}
else 
{
...
<title>Location de voitures | Poster témoignage</title>
<!--Bootstrap -->
...
<!-- Start Switcher -->
<?php include('includes/switcher coleur.php');?>
<!-- /Switcher -->  
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Poster témoignage</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Accueil</a></li>
        <li>Poster témoignage</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
  ...
  <div class="container">
	...
	<div class="col-md-3 col-sm-3">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">Publier un témoignage</h5>
